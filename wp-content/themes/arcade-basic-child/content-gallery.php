		...
		<div class="row gallery-row">
			<div class="col-md-6 parent">
				...
				<div class="col-md-12 link-background child">
					<a href="http://localhost:8888/stubar/?p=41"><?php the_field('construction_gallery_title'); ?></a>
				</div>
			</div>
			<div class="col-md-6 parent">
				<img id="renovations-gallery-image" src="<?php the_field('renovations_link_image'); ?>" alt="Example image of <?php the_title(); ?>">
				<div class="col-md-12 link-background child">
					<a href="http://localhost:8888/stubar/?p=49"><?php the_field('renovations_gallery_title'); ?></a>
				</div>
			</div>
		</div>
	</div><!-- .entry-content -->	
